  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/payments_help" element={<Paymenthelp />} />
        <Route path="/return_policy" element={<Returnpolicy />} />
        <Route path="/shipping_help" element={<Shippinghelp />} />
        <Route path="/cancellation_returns_help" element={<CancellationHelp />} />
        ...
        <Route path="/process/payment/paypal" element={<Paypal />} />
        <Route path="/process/payment/cod" element={<Cashondelivery />} />
