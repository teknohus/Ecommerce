...
import logo from '../../../assets/images/forever1.png';
      ...
      <div className="w-full sm:w-9/12 px-1 sm:px-4 m-auto flex justify-between items-center relative">
        ...
        <div className="flex items-center flex-1">
          <Link className="h-7 mr-1 sm:mr-4" to="/">
            ...
            <img draggable="false" style={{height:'60px', width:'70px', marginTop:'-17px'}} src={logo} alt="Flipkart Logo" />
            {/* <h1 className="h-full w-full object-contain" style={{color:'white', fontSize:'30px'}} ><b>ForEver</b></h1> */}
          </Link>
