...
//   const specificationsArray = specs.map((spec) => {
//     return {
//       title: spec.title,
...
const NewProduct = () => {
  ...
  const handleLogoChange = (e) => {
    ...
    reader.onload = () => {
      if (reader.readyState === 2) {
        ...
        // Extract base64Logo data (excluding data URL prefix)
        const base64Logo = reader.result.split(',')[1];
  
        // Include base64Logo in your API request to the backend
  ...
  const newProductSubmitHandler = (e) => {
    ...
    // Ensure images is an array before sending the request
