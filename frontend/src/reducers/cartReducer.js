import { ADD_TO_CART, EMPTY_CART, REMOVE_FROM_CART, SAVE_SHIPPING_INFO , CLEAR_CART } from "../constants/cartConstants";
...
export const cartReducer1 = (state = initialState, action) => {
  switch (action.type) {
    case CLEAR_CART:
      return {
        ...state,
        cartItems: [],
        // reset other cart-related state properties if necessary
      };
